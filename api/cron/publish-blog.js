...
// server/_vercel/cron-publish-blog.ts
var cron_publish_blog_exports = {};
__export(cron_publish_blog_exports, {
  default: () => handler
});
module.exports = __toCommonJS(cron_publish_blog_exports);
