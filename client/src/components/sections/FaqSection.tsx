...
const FAQ_ITEMS = [
  {
    id: "what-is",
    icon: <Zap className="w-5 h-5 text-cyan-600 shrink-0" />,
  ...
  {
    id: "security",
    icon: <Shield className="w-5 h-5 text-cyan-600 shrink-0" />,
  ...
  {
    id: "get-started",
    icon: <Wallet className="w-5 h-5 text-cyan-600 shrink-0" />,
  ...
  {
    id: "referral",
    icon: <Users className="w-5 h-5 text-cyan-600 shrink-0" />,
  ...
  {
    id: "minimum",
    icon: <HelpCircle className="w-5 h-5 text-cyan-600 shrink-0" />,
            ...
            <Accordion type="single" collapsible className="space-y-3">
              {FAQ_ITEMS.map((item, index) => (
                <AnimatedSection key={item.id} delay={0.1 + index * 0.05}>
                  ...
                  >
                    <AccordionTrigger className="px-5 py-5 text-base md:text-lg font-semibold text-slate-800 hover:no-underline hover:text-cyan-700 transition-colors gap-3 [&[data-state=open]]:text-cyan-700">
                      <div className="flex items-center gap-3">
                        {item.icon}
                        <span>{item.question}</span>
                      </div>
                    </AccordionTrigger>
                    <AccordionContent className="px-5 pb-5 text-slate-500 text-sm md:text-base leading-relaxed">
                      <div className="pl-8">
                        {item.answer}
                      </div>
                    </AccordionContent>
