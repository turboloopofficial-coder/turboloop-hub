...
export default function PartnersBar() {
  return (
    <section
      className="relative py-12 md:py-14 border-y border-slate-200/60"
    ...
    >
      <div className="container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 gap-3 md:gap-6 max-w-5xl mx-auto">
          {PARTNERS.map((p, i) => {
            const Icon = p.icon;
            return (
              <motion.div
