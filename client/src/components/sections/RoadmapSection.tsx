    ...
    <section id="roadmap" className="section-spacing relative">
      <div className="container">
        ...
        <div className="max-w-5xl mx-auto flex justify-between mb-8 px-4">
          <span className="text-xs font-bold tracking-wider text-cyan-600/60 uppercase">The Foundation</span>
          <span className="text-xs font-bold tracking-wider text-purple-500/60 uppercase">The Road Ahead</span>
        </div>
          ...
          <div className="relative">
            ...
            <div className="absolute top-10 left-0 right-0 h-[2px]">
              ...
              <div className="absolute right-0 h-full" style={{
                width: "34%",
                background: "repeating-linear-gradient(90deg, rgba(148,163,184,0.3) 0px, rgba(148,163,184,0.3) 8px, transparent 8px, transparent 16px)",
              }} />
            </div>
                    ...
                    <div className="relative flex flex-col items-center">
                      ...
                      <div
                        ...
                        style={{
                          ...
                          boxShadow: isCurrent
                            ? "0 0 25px rgba(8,145,178,0.2), inset 0 0 10px rgba(8,145,178,0.05)"
                            : isCompleted
                      ...
                      <div className="mt-4 text-center">
                        <p className="text-[10px] font-bold tracking-wider mb-1"
                          style={{ color: isCompleted || isCurrent ? "#0891B2" : "#94A3B8" }}
                        >
                          PHASE {phase.phase}
                        </p>
                        <p className="text-[11px] leading-tight max-w-[90px] mx-auto"
                          style={{ color: isCompleted ? "#64748B" : isCurrent ? "#334155" : "#94A3B8" }}
                        >
                          {phase.title}
                        </p>
                      </div>
        ...
        <div className="md:hidden max-w-sm mx-auto">
          <div className="relative">
            ...
            <div className="absolute left-[23px] top-0 bottom-0 w-[2px]">
              <div className="h-[66%]" style={{ background: "#0891B2", boxShadow: "0 0 6px rgba(8,145,178,0.2)" }} />
              <div className="h-[34%]" style={{ background: "repeating-linear-gradient(180deg, rgba(148,163,184,0.3) 0px, rgba(148,163,184,0.3) 6px, transparent 6px, transparent 12px)" }} />
            </div>
                    ...
                    <div className="relative flex items-start gap-4">
                      ...
                      <div
                        ...
                        style={{
                          ...
                          border: isCompleted || isCurrent
                            ? "2px solid rgba(8,145,178,0.3)"
                            : "1px solid rgba(0,0,0,0.06)",
                          boxShadow: isCurrent ? "0 0 15px rgba(8,145,178,0.15)" : "none",
                        }}
                      >
                        {isCompleted ? (
                          <CheckCircle2 className="h-5 w-5 text-cyan-600" />
                      ...
                      <div className="pt-2">
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-bold" style={{ color: isCompleted || isCurrent ? "#0891B2" : "#94A3B8" }}>
                            Phase {phase.phase}
                          </span>
                          {isCurrent && (
