...
const LINK_MAP: Array<{ term: RegExp; slug: string; label: string }> = [
  ...
  {
    term: /\b(Revenue Flywheel)\b/g,
    slug: "turbo-loop-revenue-flywheel-explained",
    label: "Revenue Flywheel",
  },
  {
    term: /\b(Leadership Program)\b/g,
    slug: "leadership-program-7-ranks-to-legend",
    label: "Leadership Program",
  },
  {
    term: /\b(20-level referral)\b/gi,
    slug: "referral-network-20-levels-how-it-works",
    label: "20-level referral",
  },
  {
    term: /\b(referral network)\b/gi,
    slug: "referral-network-20-levels-how-it-works",
    label: "referral network",
  },
  {
    term: /\b(\$100,?000\s*(?:Smart Contract\s*)?(?:Bounty|Challenge|bug bounty))\b/gi,
    slug: "the-100k-smart-contract-challenge",
    label: "$100,000 Bounty",
  },
  {
    term: /\b(Content Creator Star)\b/gi,
    slug: "content-creator-star-program",
    label: "Content Creator Star",
  },
  {
    term: /\b(Zoom Presenter)\b/gi,
    slug: "zoom-presenter-program-monthly-payout",
    label: "Zoom Presenter",
  },

  // Concepts
  {
    term: /\b(renounced ownership|ownership renounced)\b/gi,
    slug: "why-renounced-ownership-changes-everything",
    label: "renounced ownership",
  },
  {
    term: /\b(LP locked|liquidity locked|LP lock)\b/gi,
    slug: "lp-lock-explained-why-liquidity-security-matters",
    label: "LP locked",
  },
  {
    term: /\b(smart contract audit|audited smart contract)\b/gi,
    slug: "smart-contract-audits-what-they-actually-check",
    label: "smart contract audit",
  },
  {
    term: /\b(impermanent loss)\b/gi,
    slug: "what-is-impermanent-loss-and-why-turboloop-doesnt-have-it",
    label: "impermanent loss",
  },
  {
    term: /\b(APY vs APR|APR vs APY)\b/gi,
    slug: "what-is-apy-vs-apr-the-difference",
    label: "APY vs APR",
  },

  // Products
  {
    term: /\b(Turbo Swap)\b/g,
    slug: "turbo-swap-dex-explained",
    label: "Turbo Swap",
  },
  {
    term: /\b(Turbo Buy)\b/g,
    slug: "turbo-buy-fiat-to-crypto-gateway",
    label: "Turbo Buy",
  },
  ...
  {
    term: /\b(BscScan)\b/g,
    slug: "verifying-a-defi-contract-on-bscscan",
    label: "BscScan",
  },
  {
    term: /\b(MetaMask)\b/g,
    slug: "setting-up-metamask-for-bsc-step-by-step",
    label: "MetaMask",
  },
  {
    term: /\b(MoonPay)\b/g,
    slug: "why-moonpay-is-the-right-onramp",
    label: "MoonPay",
  },
  {
    term: /\b(BSC|Binance Smart Chain)\b/g,
    slug: "bsc-vs-ethereum-fees-explained",
    label: "BSC",
  },
];
  ...
  return lines
    .map(line => {
      ...
      for (const { term, slug, label } of LINK_MAP) {
        ...
        const matches = Array.from(processed.matchAll(term));
        ...
        for (const m of matches) {
          ...
          const insideLinkUrl =
            ...
            before.slice(lastOpenParen).includes("](");
