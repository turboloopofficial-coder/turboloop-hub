...
export const FILMS: Film[] = [
  // ═════════ SEASON 1 — THE PROBLEM ═════════
  {
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/bank-is-lying.jpg`,
  },
  {
    season: 1, episode: 2,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/where-does-money-go.jpg`,
  },
  {
    season: 1, episode: 3,
    slug: "inflation-trap",
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/inflation-trap.jpg`,
  },
  {
    season: 1, episode: 4,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/why-rich-stay-rich.jpg`,
  },
  {
    season: 1, episode: 5,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/system-not-built-for-you.jpg`,
  },
  ...
  // ═════════ SEASON 2 — THE SOLUTION ═════════
  {
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/what-is-turboloop.jpg`,
  },
  {
    season: 2, episode: 2,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/smart-contract-bank-manager.jpg`,
  },
  {
    season: 2, episode: 3,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/54-percent-real-math.jpg`,
  },
  {
    season: 2, episode: 4,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/20-level-network.jpg`,
  },
  {
    season: 2, episode: 5,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/stablecoins-stay-safe.jpg`,
  },
  ...
  // ═════════ SEASON 3 — THE PROOF ═════════
  {
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/code-is-law.jpg`,
  },
  {
    season: 3, episode: 2,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/myth-buster-ponzi.jpg`,
  },
  {
    season: 3, episode: 3,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/blockchain-never-lies-film.jpg`,
  },
  {
    season: 3, episode: 4,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/unbreakable-vault.jpg`,
  },
  {
    season: 3, episode: 5,
    slug: "defi-vs-banks",
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/defi-vs-banks.jpg`,
  },
  ...
  // ═════════ SEASON 4 — THE MOVEMENT ═════════
  {
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/global-revolution-lagos-london.jpg`,
  },
  {
    season: 4, episode: 2,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/compounding-secret.jpg`,
  },
  {
    season: 4, episode: 3,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/build-your-legacy.jpg`,
  },
  {
    season: 4, episode: 4,
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/leadership-path.jpg`,
  },
  {
    season: 4, episode: 5,
    slug: "manifesto",
    ...
    posterUrl: `${R2_BASE}/cinematic-thumbs/manifesto.jpg`,
  },
];
