...
export const CREATIVES: Creative[] = [
  ...
  },
  {
    ...
    caption: "Adaeze and the Nigerian team host weekly Zoom calls — over 200 members and growing.",
    emoji: "🇳🇬",
  ...
  },
  {
    ...
    caption: "Budi's downline now spans three countries. The Southeast Asia hub is on fire.",
    emoji: "🚀",
    byline: "Top growth in Q2",
