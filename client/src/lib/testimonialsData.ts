...
export const TESTIMONIALS: Testimonial[] = [
  ...
  // — additional voices for the rotation pool (so each day a different one cycles to the top)
  {
    id: "tomas-cz",
    quote: "Joined for the security model, stayed for the community. The Czech crew is small but loud — we love it here.",
    name: "Tomáš Novák",
    role: "Czech Republic",
    countryCode: "cz",
    color: "#0EA5E9",
  ...
  {
    id: "anya-ua",
    quote: "Контракт чистий. Спільнота справжня. Лідерство працює.",
    name: "Anya Kovalenko",
    role: "Ukraine",
    countryCode: "ua",
    color: "#7C3AED",
  ...
  },
  {
    id: "javier-ar",
    quote:
      "Hace semanas que estoy en TurboLoop y la comunidad latinoamericana crece todos los días. Las sesiones en español son oro.",
    name: "Javier Morales",
    role: "Argentina",
    countryCode: "ar",
    color: "#0891B2",
  ...
  {
    id: "eunice-za",
    quote: "Africa needs more projects like this. Transparent. Open. Verifiable. No drama.",
    name: "Eunice Dlamini",
    role: "South Africa",
    countryCode: "za",
    color: "#10B981",
  ...
  },
  {
    id: "rashid-eg",
    quote:
      "What sold me was the bug bounty. $100K to anyone who finds centralization. That's how confident a team should be in their code.",
    name: "Rashid El-Sayed",
    role: "Egypt",
    countryCode: "eg",
    color: "#EC4899",
    hoursAgo: 140,
  ...
  {
    id: "julia-ro",
    quote: "Honest, open, growing. That's all I need from a DeFi project.",
    name: "Julia Popescu",
    role: "Romania",
    countryCode: "ro",
    color: "#F59E0B",
  ...
  },
  {
    id: "siti-my",
    quote:
      "The Malaysian community started one Zoom and it filled up the next week. People want to learn — TurboLoop just makes it easy.",
    name: "Siti Rahman",
    role: "Malaysia",
    countryCode: "my",
    color: "#0EA5E9",
  ...
  {
    id: "mateusz-pl",
    quote: "Finally a DeFi project that says 'verify' instead of 'trust us'.",
    name: "Mateusz Wójcik",
    role: "Poland",
    countryCode: "pl",
    color: "#7C3AED",
  ...
  },
  {
    id: "kim-kr",
    quote:
      "Tested the contract on testnet myself before going in. Clean code. Renounced ownership verified. Real DeFi, not promises.",
    name: "Min-jun Kim",
    role: "South Korea",
    countryCode: "kr",
    color: "#DC2626",
  ...
  {
    id: "lina-co",
    quote: "Mi familia colombiana ahora también está construyendo. Eso es lo que más me gusta.",
    name: "Lina Castaño",
    role: "Colombia",
    countryCode: "co",
    color: "#10B981",
