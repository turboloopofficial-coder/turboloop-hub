...
const VALID_LANGS = new Set(["en", "hi", "af", "de"]);
...
export async function GET(request: Request) {
  ...
  // "af" and "de" use "en" banner until lang-specific R2 images are generated
  const lang = VALID_LANGS.has(rawLang) ? (rawLang === "af" || rawLang === "de" ? "en" : rawLang) : "hi";
