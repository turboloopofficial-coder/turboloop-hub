...
const LOCALE_TO_CREATIVE_LANG: Record<string, CreativeLanguage> = {
  ...
  ja: "ja", pt: "pt", ru: "ru", vi: "vi", tl: "tl", ms: "ms", nl: "nl",
};
...
const TITLE = "Marketing Hub — 3,800+ Free DeFi Banners in 26 Languages | TurboLoop";
const DESCRIPTION =
  "Download 3,800+ free DeFi marketing banners. 26 languages, campaign suites, branded educational kit. Free for the TurboLoop community — no attribution required.";
        ...
        <Container width="wide">
          <section className="mt-8 mb-16 p-6 rounded-2xl bg-[var(--c-surface)] border border-[var(--c-border)]">
            ...
            <p className="text-sm text-[var(--c-text-subtle)] leading-relaxed">
              ...
              <strong>{TOTAL_CREATIVES.toLocaleString()} free banners</strong> across {TOTAL_CATEGORIES} categories and 26 languages.
