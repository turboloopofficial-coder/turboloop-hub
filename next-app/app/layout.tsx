...
export const metadata: Metadata = {
  ...
  // launch is stable. Icons are auto-generated by Next.js from
  // app/icon.svg (the brand mark).
  appleWebApp: {
    capable: true,
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        {/* SERVICE WORKER CLEANUP — critical for users who installed the
            legacy SPA's PWA. The old sw.js intercepts every request and
            returns stale Vite HTML, which is why the site looked broken
            on Brave but worked on Chrome (Brave had the SW registered;
            Chrome didn't). This script unregisters every SW + clears
            caches once per device, then forces one reload to pull the
            new Next.js build fresh from network. */}
        <script
          dangerouslySetInnerHTML={{
            __html: `
              (function () {
                try {
                  var DONE = 'tl_sw_cleanup_v1';
