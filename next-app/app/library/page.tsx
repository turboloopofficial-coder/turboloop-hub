                ...
                >
                  ...
                  {pres.fileUrl && (
                    <a
                      ...
                      className="inline-flex items-center justify-center w-11 h-11 min-w-[44px] min-h-[44px] rounded-[var(--r-md)] bg-[var(--c-bg)] text-[var(--c-text-muted)] hover:text-[var(--c-brand-cyan)] hover:bg-[var(--c-surface)] border border-[var(--c-border)] transition shrink-0"
