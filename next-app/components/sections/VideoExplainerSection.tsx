...
const LANGUAGES: {
  ...
  { code: "ar", label: "Arabic",     nativeLabel: "العربية",     flag: "🇸🇦", video: `${R2_BASE}/turboloop-explainer-ar.mp4`, ep2video: `${R2_BASE}/turboloop-ep2-ar.mp4`, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/wmeBIIRu660", ep2youtubeUrl: null },
