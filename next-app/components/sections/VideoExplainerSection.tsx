...
// ── Language registry ────────────────────────────────────────────────────────
// `video` / `ep2video` are null until dubbed versions are uploaded to R2.
// When null the player falls back to the English source automatically.
const LANGUAGES: {
  code: string;
  label: string;
  nativeLabel: string;
  flag: string;
  video: string | null;       // Episode 1
  ep2video: string | null;    // Episode 2
  thumb: string | null;
  ...
  { code: "no", label: "Norwegian",  nativeLabel: "Norsk",       flag: "🇳🇴", video: `${R2_BASE}/turboloop-explainer-no.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  ...
  { code: "sk", label: "Slovak",     nativeLabel: "Slovenčina",  flag: "🇸🇰", video: `${R2_BASE}/turboloop-explainer-sk.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  ...
  { code: "bg", label: "Bulgarian",  nativeLabel: "Български",   flag: "🇧🇬", video: `${R2_BASE}/turboloop-explainer-bg.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "hr", label: "Croatian",   nativeLabel: "Hrvatski",    flag: "🇭🇷", video: `${R2_BASE}/turboloop-explainer-hr.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "sr", label: "Serbian",    nativeLabel: "Српски",      flag: "🇷🇸", video: `${R2_BASE}/turboloop-explainer-sr.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "sl", label: "Slovenian",  nativeLabel: "Slovenščina", flag: "🇸🇮", video: `${R2_BASE}/turboloop-explainer-sl.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "lt", label: "Lithuanian", nativeLabel: "Lietuvių",    flag: "🇱🇹", video: `${R2_BASE}/turboloop-explainer-lt.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "lv", label: "Latvian",    nativeLabel: "Latviešu",    flag: "🇱🇻", video: `${R2_BASE}/turboloop-explainer-lv.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "et", label: "Estonian",   nativeLabel: "Eesti",       flag: "🇪🇪", video: `${R2_BASE}/turboloop-explainer-et.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "ms", label: "Malay",      nativeLabel: "Bahasa Melayu", flag: "🇲🇾", video: `${R2_BASE}/turboloop-explainer-ms.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "tl", label: "Filipino",   nativeLabel: "Filipino",    flag: "🇵🇭", video: `${R2_BASE}/turboloop-explainer-tl.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  ...
  { code: "bn", label: "Bengali",    nativeLabel: "বাংলা",       flag: "🇧🇩", video: `${R2_BASE}/turboloop-explainer-bn.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "te", label: "Telugu",     nativeLabel: "తెలుగు",      flag: "🇮🇳", video: `${R2_BASE}/turboloop-explainer-te.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "mr", label: "Marathi",    nativeLabel: "मराठी",       flag: "🇮🇳", video: `${R2_BASE}/turboloop-explainer-mr.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "gu", label: "Gujarati",   nativeLabel: "ગુજરાતી",     flag: "🇮🇳", video: `${R2_BASE}/turboloop-explainer-gu.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "kn", label: "Kannada",    nativeLabel: "ಕನ್ನಡ",       flag: "🇮🇳", video: `${R2_BASE}/turboloop-explainer-kn.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "ml", label: "Malayalam",  nativeLabel: "മലയാളം",      flag: "🇮🇳", video: `${R2_BASE}/turboloop-explainer-ml.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "ur", label: "Urdu",       nativeLabel: "اردو",        flag: "🇵🇰", video: `${R2_BASE}/turboloop-explainer-ur.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "fa", label: "Persian",    nativeLabel: "فارسی",       flag: "🇮🇷", video: `${R2_BASE}/turboloop-explainer-fa.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "he", label: "Hebrew",     nativeLabel: "עברית",       flag: "🇮🇱", video: `${R2_BASE}/turboloop-explainer-he.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "sw", label: "Swahili",    nativeLabel: "Kiswahili",   flag: "🇰🇪", video: `${R2_BASE}/turboloop-explainer-sw.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
  { code: "am", label: "Amharic",    nativeLabel: "አማርኛ",        flag: "🇪🇹", video: `${R2_BASE}/turboloop-explainer-am.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: null, ep2youtubeUrl: null },
...
// ── Shared VideoPlayer sub-component ─────────────────────────────────────────
type Episode = "ep1" | "ep2";
...
function VideoPlayer({
  ...
  const isEp1 = episode === "ep1";
  const getVideo = (lang: typeof LANGUAGES[0]) => isEp1 ? lang.video : lang.ep2video;
  const getYoutube = (lang: typeof LANGUAGES[0]) => isEp1 ? lang.youtubeUrl : lang.ep2youtubeUrl;
  const isAvailable = (lang: typeof LANGUAGES[0]) => getVideo(lang) !== null;

  // For ep2, fall back to English ep2 video if selected lang doesn't have ep2 yet
  const activeVideo = getVideo(selectedLang) ?? (isEp1 ? ENGLISH.video! : ENGLISH.ep2video!);
  const activeThumb = selectedLang.thumb ?? ENGLISH.thumb!;
  const activeYoutubeUrl = getYoutube(selectedLang) ?? getYoutube(ENGLISH);
  ...
  const durationLabel = isEp1 ? "20 min" : "21 min";
  const downloadName = isEp1
    ? `TurboLoop-Explainer-${selectedLang.label}.mp4`
    : `TurboLoop-CEO-QA-${selectedLang.label}.mp4`;
      ...
      <div className="relative w-full" style={{ paddingBottom: "56.25%" }}>
        ...
        {!started && (
          <div className="absolute inset-0 w-full h-full">
            ...
            <img
              src={activeThumb}
              alt={`${selectedLang.label} ${isEp1 ? "explainer" : "CEO Q&A"} thumbnail`}
      ...
      <div className="px-4 sm:px-6 py-3 sm:py-4 bg-white/[0.03] border-t border-white/[0.06] flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-sm text-gray-400">
            {selectedLang.label} · {durationLabel} · Full HD
          </span>
        </div>
    ...
    <section className="relative py-16 md:py-24 bg-[#080c14] overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-xs text-gray-600 uppercase tracking-widest font-semibold">Next Episode</span>
          <div className="flex-1 h-px bg-white/[0.06]" />
        </div>
