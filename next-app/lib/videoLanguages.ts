...
export const LANGUAGES: VideoLanguage[] = [
  ...
  { code: "ar", label: "Arabic",     nativeLabel: "العربية",     flag: "🇸🇦", video: `${R2_BASE}/turboloop-explainer-ar.mp4`, ep2video: `${R2_BASE}/turboloop-ep2-ar.mp4`, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/wmeBIIRu660", ep2youtubeUrl: "https://youtu.be/lrlCjXPlf8c" },
  ...
  { code: "zu", label: "Zulu",       nativeLabel: "isiZulu",     flag: "🇿🇦", video: `${R2_BASE}/turboloop-explainer-zu.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/Ho_dPu1uL1k", ep2youtubeUrl: "https://youtu.be/Ho_dPu1uL1k" },
  ...
  { code: "az", label: "Azerbaijani", nativeLabel: "Azərbaycan",  flag: "🇦🇿", video: `${R2_BASE}/turboloop-explainer-az.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/7fBj0OA7OQA", ep2youtubeUrl: "https://youtu.be/7fBj0OA7OQA" },
  { code: "kk", label: "Kazakh",      nativeLabel: "Қазақша",     flag: "🇰🇿", video: `${R2_BASE}/turboloop-explainer-kk.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/6aAnMuf5wZ0", ep2youtubeUrl: "https://youtu.be/6aAnMuf5wZ0" },
  { code: "uz", label: "Uzbek",       nativeLabel: "O'zbek",      flag: "🇺🇿", video: `${R2_BASE}/turboloop-explainer-uz.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/ZIkhITW8jkg", ep2youtubeUrl: "https://youtu.be/ZIkhITW8jkg" },
  { code: "my", label: "Burmese",     nativeLabel: "မြန်မာဘာသာ",  flag: "🇲🇲", video: `${R2_BASE}/turboloop-explainer-my.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/hoGpuRboFnA", ep2youtubeUrl: "https://youtu.be/hoGpuRboFnA" },
  { code: "km", label: "Khmer",       nativeLabel: "ភាសាខ្មែរ",   flag: "🇰🇭", video: `${R2_BASE}/turboloop-explainer-km.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/1xQzWuHcpKg", ep2youtubeUrl: "https://youtu.be/1xQzWuHcpKg" },
  { code: "si", label: "Sinhala",     nativeLabel: "සිංහල",       flag: "🇱🇰", video: `${R2_BASE}/turboloop-explainer-si.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/c43wldmzNSs", ep2youtubeUrl: "https://youtu.be/c43wldmzNSs" },
  { code: "ne", label: "Nepali",      nativeLabel: "नेपाली",      flag: "🇳🇵", video: `${R2_BASE}/turboloop-explainer-ne.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/4SMJe37CDaU", ep2youtubeUrl: "https://youtu.be/4SMJe37CDaU" },
  { code: "pa", label: "Punjabi",     nativeLabel: "ਪੰਜਾਬੀ",      flag: "🇮🇳", video: `${R2_BASE}/turboloop-explainer-pa.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/kM6v8b4Da6s", ep2youtubeUrl: "https://youtu.be/kM6v8b4Da6s" },
  { code: "lo", label: "Lao",         nativeLabel: "ລາວ",         flag: "🇱🇦", video: `${R2_BASE}/turboloop-explainer-lo.mp4`, ep2video: null, thumb: `${R2_BASE}/turboloop-explainer-en-thumb.jpg`, youtubeUrl: "https://youtu.be/JwK7-rRwdtI", ep2youtubeUrl: "https://youtu.be/JwK7-rRwdtI" },
];
