...
// ── Thai T-60 pool ────────────────────────────────────────────────────────
const TH_T60 = [
  `<b>🇹🇭 ประชุม TurboLoop — อีก 1 ชั่วโมง</b>

เตรียมคำถามของคุณ! ห้องประชุมจะเปิดใน 60 นาที
มาพร้อมกันทุกวัน — เรียนรู้ อัปเดต และเติบโตไปด้วยกัน 🚀`,
  `<b>🇹🇭 การแชร์ความรู้ TurboLoop — 1 ชั่วโมงข้างหน้า</b>

อีก 60 นาทีเท่านั้น! เข้าร่วมและรับข้อมูลอัปเดตล่าสุดจากทีมงาน`,
  `<b>🇹🇭 TurboLoop Thai Call — เหลืออีก 60 นาที</b>

เตรียมตัวให้พร้อม ห้องจะเปิดในอีก 1 ชั่วโมง มาเรียนรู้ร่วมกัน!`,
  `<b>🇹🇭 นัดประชุมประจำวัน — อีก 1 ชั่วโมง</b>

อย่าพลาด! เข้าร่วม Google Meet กับทีม TurboLoop ในอีก 60 นาที`,
  `<b>🇹🇭 TurboLoop Daily Call — 60 นาที</b>

เชิญทุกท่านเข้าร่วม เรียนรู้พื้นฐาน รับข้อมูลอัปเดต และถามคำถามได้เลย!`,
];
// ── Thai T-30 pool ────────────────────────────────────────────────────────
const TH_T30 = [
  `<b>🇹🇭 ประชุม TurboLoop — อีก 30 นาที!</b>

ห้องประชุมจะเปิดในอีกครึ่งชั่วโมง มาพร้อมกันนะ! 🙌`,
  `<b>🇹🇭 การแชร์ความรู้ TurboLoop — เหลืออีก 30 นาที</b>

เตรียมตัวให้พร้อม! อีก 30 นาทีเราจะเริ่มต้นด้วยกัน`,
  `<b>🇹🇭 TurboLoop Thai Call — 30 นาทีก่อนเริ่ม</b>

ห้องกำลังจะเปิด อีก 30 นาที มาเจอกันนะ!`,
  `<b>🇹🇭 นัดประชุมประจำวัน — เหลืออีก 30 นาที</b>

อย่าลืม! เข้าร่วม Google Meet กับ Mr. Keang ในอีก 30 นาที 🎙️`,
  `<b>🇹🇭 TurboLoop Daily Call — 30 นาที</b>

ครึ่งชั่วโมงก็จะถึงเวลา มาเรียนรู้และอัปเดตข้อมูลร่วมกัน!`,
];
// ── Thai T-15 pool ────────────────────────────────────────────────────────
const TH_T15 = [
  `<b>🇹🇭 ประชุม TurboLoop — อีก 15 นาที!</b>

เกือบถึงเวลาแล้ว! เข้าร่วมได้เลยก่อนห้องเต็ม 🔥`,
  `<b>🇹🇭 TurboLoop Thai Call — 15 นาทีสุดท้าย</b>

นาทีทอง! อีก 15 นาทีเราจะเริ่มต้น มาให้ทัน!`,
  `<b>🇹🇭 เกือบถึงเวลาแล้ว — 15 นาที</b>

เตรียมตัวเข้าห้อง Google Meet ได้เลย เริ่มในอีก 15 นาที!`,
  `<b>🇹🇭 TurboLoop Daily Call — 15 นาที</b>

รีบเข้าร่วมก่อนเริ่ม! ห้องจะเปิดในอีก 15 นาที 🚀`,
  `<b>🇹🇭 นัดประชุมประจำวัน — 15 นาทีสุดท้าย!</b>

อย่าพลาดโอกาสนี้ เข้าร่วมได้เลยใน 15 นาที!`,
];
// ── Thai LIVE pool ─────────────────────────────────────────────────────────
const TH_LIVE = [
  `🔴 <b>🇹🇭 TurboLoop Thai Call — เราเริ่มแล้ว! LIVE NOW</b>

ห้องเปิดแล้ว! เข้าร่วมได้เลยทันที อย่ารอช้า!`,
  `🔴 <b>🇹🇭 LIVE แล้ว — TurboLoop Daily Call</b>

เราเริ่มต้นแล้ว! คลิกลิงก์และเข้าร่วมได้เลย 🎙️`,
  `🔴 <b>🇹🇭 ประชุม TurboLoop — กำลัง LIVE อยู่!</b>

ห้องเปิดอยู่ตอนนี้ เข้าร่วมได้เลย ไม่ต้องรอ!`,
  `🔴 <b>🇹🇭 TurboLoop Thai Call — เริ่มแล้ว!</b>

มาเจอกันได้เลย ห้องกำลัง LIVE อยู่ตอนนี้!`,
  `🔴 <b>🇹🇭 LIVE NOW — TurboLoop ชุมชนไทย</b>
...
export const CAMPAIGN_EDUCATION_CAPTIONS = [
  ...
  `What is ROI? — Return on Investment, explained for DeFi.\n\nROI = (Earnings / Investment) × 100. TurboLoop's Ultimate Plan returns 54% fixed yield over 60 days — plus your full capital back at end of term. Compare that to any bank.\n\n👉 https://turboloop.tech/calculator\n\n#ROI #DeFiEducation #TurboLoop #DeFiYield #PassiveIncome`,
...
export const CAMPAIGN_GERMAN_CAPTIONS = [
  `🇩🇪🚀 Finanzielle Freiheit beginnt mit TurboLoop!\n\nDeFi-Renditen auf BSC: 7 Tage (3%), 14 Tage (10%), 30 Tage (24%), 60 Tage (54%). Kapital + Gewinne werden am Ende der Laufzeit zurückgegeben.\n\n👉 https://turboloop.tech\n\n#TurboLoop #DeFi #PassivesEinkommen #USDT`,
